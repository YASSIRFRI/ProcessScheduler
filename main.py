...
# def render_turnaround_time_chart2(processes, start_times, durations, arrival_times, app_layout):
...
# def render_waiting_time_chart2(processes, start_times, durations, arrival_times, app_layout):
#         waiting_times= {process: 0 for process in processes}
#         for p in set(processes):
#             last_run=arrival_times[p]
#             for i in range(len(processes)):
...
# def render_process_table2(processes, start_times, durations, arrival_times, app_layout):
#     start_time_dict = {process: start_times[i] for i, process in enumerate(processes)}
#     durations_dict = {process: 0 for process in processes}
#     for i, process in enumerate(processes):
#         start_time_dict[process] = min(start_time_dict[process], start_times[i])
...
#         render_turnaround_time_chart2(processes[key], start_times[key],durations[key],arrival_times[key], app_layout)
#         render_process_table2(processes[key], start_times[key], durations[key],arrival_times[key], app_layout)
#         render_waiting_time_chart2(processes[key], start_times[key], durations[key], arrival_times[key], app_layout)
#         add_footer(app_layout)
#     dash_app.layout = html.Div(app_layout)
